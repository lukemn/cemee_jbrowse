...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /Users/lukenoble/jbrowse/extlib
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /Users/lukenoble/jbrowse/extlib/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 7.34
MM_REVISION = 73400
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="darwin-thread-multi-2level-5.18" />' >> JBrowse.ppd
