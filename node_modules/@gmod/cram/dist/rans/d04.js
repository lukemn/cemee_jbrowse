...
/* ByteBuffer */out) {
  ...
  for (var i = 0; i < outputEnd; i += 4) {
    var /* byte */c0 = D.R[Decoding.get(rans0, Constants.TF_SHIFT)];
    var /* byte */c1 = D.R[Decoding.get(rans1, Constants.TF_SHIFT)];
    var /* byte */c2 = D.R[Decoding.get(rans2, Constants.TF_SHIFT)];
    var /* byte */c3 = D.R[Decoding.get(rans3, Constants.TF_SHIFT)];
