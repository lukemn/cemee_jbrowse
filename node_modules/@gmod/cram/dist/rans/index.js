...
var ByteBuffer = function () {
  function ByteBuffer(nodeBuffer) {
    ...
    (0, _classCallCheck3.default)(this, ByteBuffer);
  ...
  (0, _createClass3.default)(ByteBuffer, [{
    key: 'get',
    value: function get() {
...
function uncompress(inputBuffer, outputBuffer) {
  ...
  var order = input.get();
  if (order !== 0 && order !== 1) throw new CramMalformedError('Invalid rANS order ' + order);
  ...
  if (output.length < outputSize) throw new CramMalformedError('Output buffer too small to fit ' + outputSize + ' bytes.');
