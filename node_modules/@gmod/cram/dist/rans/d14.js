...
/* Decoding.Symbol[][] */syms) {
  ...
  for (; i0 < isz4; i0 += 1, i1 += 1, i2 += 1, i7 += 1) {
    var /* int */c0 = 0xff & D[l0].R[Decoding.get(rans0, Constants.TF_SHIFT)];
    var /* int */c1 = 0xff & D[l1].R[Decoding.get(rans1, Constants.TF_SHIFT)];
    var /* int */c2 = 0xff & D[l2].R[Decoding.get(rans2, Constants.TF_SHIFT)];
    var /* int */c7 = 0xff & D[l7].R[Decoding.get(rans7, Constants.TF_SHIFT)];
  ...
  for (; i7 < outputSize; i7 += 1) {
    var /* int */_c = 0xff & D[l7].R[Decoding.get(rans7, Constants.TF_SHIFT)];
    output.putAt(i7, _c);
