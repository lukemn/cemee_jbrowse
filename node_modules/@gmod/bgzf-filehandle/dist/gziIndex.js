'use strict';var _regenerator = require('babel-runtime/regenerator');var _regenerator2 = _interopRequireDefault(_regenerator);var _asyncToGenerator2 = require('babel-runtime/helpers/asyncToGenerator');var _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);var _minSafeInteger = require('babel-runtime/core-js/number/min-safe-integer');var _minSafeInteger2 = _interopRequireDefault(_minSafeInteger);var _maxSafeInteger = require('babel-runtime/core-js/number/max-safe-integer');var _maxSafeInteger2 = _interopRequireDefault(_maxSafeInteger);var _classCallCheck2 = require('babel-runtime/helpers/classCallCheck');var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _createClass2 = require('babel-runtime/helpers/createClass');var _createClass3 = _interopRequireDefault(_createClass2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var Long = require('long');
...
GziIndex = function () {
  function GziIndex(_ref) {var filehandle = _ref.filehandle,path = _ref.path;(0, _classCallCheck3.default)(this, GziIndex);
    if (filehandle) this.filehandle = filehandle;else
    if (path) this.filehandle = new LocalFile(path);else
    throw new TypeError('either filehandle or path must be defined');
  }(0, _createClass3.default)(GziIndex, [{ key: '_readLongWithOverflow', value: function _readLongWithOverflow(
    ...
    buf) {var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;var unsigned = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      ...
      if (
      long.greaterThan(_maxSafeInteger2.default) ||
      long.lessThan(_minSafeInteger2.default))
...

    {
      ...
      return this.index;
    } }, { key: '_readIndex', value: function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {var buf, numEntries, entries, bufSize, entryNumber, compressedPosition, uncompressedPosition;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                bufSize > _maxSafeInteger2.default)) {_context.next = 11;break;}throw (
                ...
                entries);case 16:case 'end':return _context.stop();}}}, _callee, this);}));function _readIndex() {return _ref2.apply(this, arguments);}return _readIndex;}()


    /**
                                                                                                                                                                              * @returns {object} the entry for the last block in the index
                                                                                                                                                                              */ }, { key: 'getLastBlock', value: function () {var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {var entries;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                ...
                entries[entries.length - 1]);case 6:case 'end':return _context2.stop();}}}, _callee2, this);}));function getLastBlock() {return _ref3.apply(this, arguments);}return getLastBlock;}()
    ...
    /**
                                                                                                                                                                                                       ...
                                                                                                                                                                                                       */ }, { key: 'getRelevantBlocksForRead', value: function () {var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(
      length, position) {var endPosition, entries, relevant, compare, lowerBound, upperBound, searchPosition, comparison, i;return _regenerator2.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                ...
                relevant);case 24:case 'end':return _context3.stop();}}}, _callee3, this);}));function getRelevantBlocksForRead(_x3, _x4) {return _ref4.apply(this, arguments);}return getRelevantBlocksForRead;}()
